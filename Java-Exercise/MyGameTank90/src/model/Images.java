...
public class Images {
	...
	public static final int BULLET_ENEMY_ID = 19;
	...
	public static final Image BULLET = new ImageIcon(
			Images.class.getResource("/images/fire.jpg")).getImage();

	public static final Image BULLET_ENEMY = new ImageIcon(
			Images.class.getResource("/images/Button_Enemy.png")).getImage();
